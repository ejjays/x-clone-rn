...
export const VerifiedBadge: React.FC<Props> = ({ size = 16, style }) => {
  // ViewBox: 0 0 122.88 116.87
  return (
    <View style={style} accessibilityLabel="Verified badge" accessible>
      <Svg width={size} height={(size * 116.87) / 122.88} viewBox="0 0 122.88 116.87">
        <Polygon
